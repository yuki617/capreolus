...
class LCEBertPassage(BertPassage):
    ...
    def create_tf_train_feature(self, sample):
        ...
        params:
        sample - A dict where each entry has the shape [batch_size, num_passages, nneg, maxseqlen]
        Returns a list of features. Each feature is a dict, and each value in the dict has the shape [batch_size, nneg, maxseqlen].
